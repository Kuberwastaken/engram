...
if (topic === 'cutoffs') {
    return (
        ...
        <h2 className="text-3xl font-bold text-blue-100 mb-6 border-b border-gray-800 pb-2" >
            { sName } { bCode } Cutoffs 2025: Analysis & Safe Rank
                ...
                < p className = "text-gray-300" >
                    ...
                    GGSIPU counseling is dynamic, but historical trends give us a clear "Safety Zone" for your JEE Main Rank.
                </p>
        ...
        tier === 1 ? "Even for top colleges like " + sName + ", Delhi quota ranks can go up to 60k-80k depending on the shift." :
        "For " + sName + ", this allows students with ranks even above 2 Lakh to hope for a seat in later rounds."
    }
    </p>

        < h3 className = "text-xl font-semibold text-blue-200 mt-8" > Outside Delhi Scenario </h3>
            < p className = "text-gray-300" >
                For the 15 % All India seats, competition is brutal.You typically need a percentile roughly < strong > { tier === 1 ? "95%+" : "85-90%+"
} </strong> to stand a chance here.
    </p>
